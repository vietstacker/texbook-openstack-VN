...
- [2 Các khái niệm cơ bản.](#khai_niem)
	...
	- [2.6 Targets](#targets)
	- [2.8 Catalog:](#catalog)
- [3. Các thành phần cơ bản trong Keystone](#thanh_phan)
...
* Keystone ra khái niệm trừu tượng mới: domain.
...
<a name="thanh_phan"></a>
#3. Các thành phần cơ bản trong Keystone
